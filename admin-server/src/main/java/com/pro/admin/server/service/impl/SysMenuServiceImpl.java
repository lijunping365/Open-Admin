...
import com.pro.admin.server.mapper.SysMenuMapper;
import com.pro.admin.server.service.SysMenuService;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenuDO> implements SysMenuService {
  ...
  @Cacheable(value = MENU_TREE, key = "#root.methodName + ':' + #userId")
  @Override
  ...
  @Cacheable(value = MENU_TREE, key = "#root.methodName")
  @Override
