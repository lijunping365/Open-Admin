...
import com.pro.admin.server.convert.SysRoleResourceConvert;
import com.pro.admin.server.dto.resp.SysResourceRespDTO;
import com.pro.admin.server.dto.update.SysRoleResourceUpdateDTO;
import com.pro.admin.server.entity.SysRoleResourceDO;
import com.pro.admin.server.mapper.SysRoleResourceMapper;
import com.pro.admin.server.service.SysRoleResourceService;
...
import static com.pro.admin.server.constant.CacheName.ROLE_RESOURCE_MAP;
...
public class SysRoleResourceServiceImpl extends ServiceImpl<SysRoleResourceMapper, SysRoleResourceDO> implements SysRoleResourceService {
  ...
  @Cacheable(value = ROLE_RESOURCE_MAP, key = "#root.methodName")
  ...
  @PreAuthorization
  @CacheEvict(value = ROLE_RESOURCE_MAP, allEntries = true)
  @Transactional
  @Override
