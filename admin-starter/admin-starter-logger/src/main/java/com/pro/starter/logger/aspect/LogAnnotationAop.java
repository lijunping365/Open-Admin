...
import com.pro.admin.common.ip.IpUtil;
...
import com.pro.starter.logger.service.LoggerRecordService;
...
public class LogAnnotationAop {
  ...
  public Object saveLog(ProceedingJoinPoint joinPoint, Logger logger) throws Throwable {
    ...
    try {
      ...
      logModel.setStatus(ResultEnum.ERROR.getCode());
      throw throwable;
    }
    return result;
  }
  ...
  private LogModel prodLogModel() {
    ...
    return new LogModel()
        .setUserId(userService.getUserModel().getUid())
